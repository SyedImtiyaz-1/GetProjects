...
function CoursePage() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://client-user-jthexgbce-syedimtiyaz-1.vercel.app/courses${id}`,
        {
          headers: {
    ...
    axios
      .get(
        "https://client-user-jthexgbce-syedimtiyaz-1.vercel.app/courses/purchased",
        {
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
          },
          ...
          {!isPurchased ? (
            <Button
              ...
              onClick={() => {
                axios
                  .post(
                    `https://client-admin-olive.vercel.app/courses/${id}`,
                    {},
                    {
                      headers: {
                        Authorization:
